        ...
        for (scene.entities) |*e| {
            ...
            switch (e.type) {
                ...
                .ball => {
                    ...
                    if (scene.collideBricks(old_pos, ball.pos)) |coll| {
                    ...
                    if (collideLevelBounds(ball.*, old_pos, ball.pos, &out, &normal)) {
                        audio.play(.{ .clip = .bounce });
                        ball.pos = out;
                ...
                .laser => {
                    if (scene.collideBricks(old_pos, e.pos)) |_| {
                        e.type = .none;
                    }
