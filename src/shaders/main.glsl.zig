...
//
//    Cmdline:
//        sokol-shdc --input src/shaders/main.glsl --output src/shaders/main.glsl.zig --slang glsl410:metal_macos:hlsl5:glsl300es:wgsl --format=sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'main':
...
//
//
const vs_source_glsl410 = [288]u8 {
...
//
//
const vs_source_glsl300es = [249]u8 {
...
const vs_source_wgsl = [820]u8 {
    ...
    0x7b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,0x31,0x38,0x20,0x3a,0x20,0x76,
    ...
    0x39,0x3b,0x0a,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,0x3b,0x0a,0x7d,0x0a,0x0a,
